...
CREATE TABLE IF NOT EXISTS custombattlerole (
    _id bigint NOT NULL,
    `system` blob DEFAULT NULL,  -- Используем обратные кавычки
...
CREATE TABLE IF NOT EXISTS account (
    ...
    ctime timestamp,
    mtime timestamp,
    serverid int unsigned DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS role (
    ...
    INDEX (account),
    KEY (nickid)
) AUTO_INCREMENT=10000 ROW_FORMAT=DYNAMIC;

CREATE TABLE IF NOT EXISTS rolesummary (
	_id bigint NOT NULL, 
	data blob NOT NULL, 
	PRIMARY KEY (_id)) ROW_FORMAT=DYNAMIC;

CREATE TABLE IF NOT EXISTS ranklist (
	_id int(11) NOT NULL, 
	data mediumblob NOT NULL,
	serverid int unsigned DEFAULT 0,
	PRIMARY KEY (_id, serverid)) ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS reward (
	...
	time timestamp,
	PRIMARY KEY (_id),
	INDEX (roleid)) ROW_FORMAT=DYNAMIC;
